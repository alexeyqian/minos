...
kernel/kernel.bin: kernel/kernel_entry.asm kernel/klib.c kernel/global.c kernel/interrupt.c kernel/proc.c \
	...
	gcc -c -m32 -fno-builtin -o kernel/proc.o      kernel/proc.c
	...
	ld -m elf_i386 -s -Ttext 0x30400 -o $@ kernel/kernel_entry.o kernel/klib.o kernel/global.o kernel/interrupt.o kernel/proc.o kernel/clock.o \
